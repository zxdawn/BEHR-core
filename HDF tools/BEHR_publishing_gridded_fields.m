classdef BEHR_publishing_gridded_fields
    ...
    properties(Constant = true)
        ...
        psm_gridded_vars = {'BEHRColumnAmountNO2Trop',...
            ...
            'ColumnAmountNO2Trop',...
            'WRF_AK_Column_NO2','WRF_AK_Column_NO2_Visonly',...
            'WRF_AK_Column_NO','WRF_AK_Column_NO_Visonly',...
            'WRF_AK_Column_HNO3','WRF_AK_Column_HNO3_Visonly',...
            'WRF_AK_Column_N2O5','WRF_AK_Column_N2O5_Visonly',...
            'WRF_AK_Column_NO3','WRF_AK_Column_NO3_Visonly',...
            'WRF_AK_Column_PAN','WRF_AK_Column_PAN_Visonly',...
            'WRF_AK_Column_HNO4','WRF_AK_Column_HNO4_Visonly',...
            'WRF_AK_Column_HONO','WRF_AK_Column_HONO_Visonly',...
            'WRF_AK_Column_MPAN','WRF_AK_Column_MPAN_Visonly',...
            'WRF_AK_Column_PPN','WRF_AK_Column_PPN_Visonly',...
            'WRF_AK_Column_MPN','WRF_AK_Column_MPN_Visonly',...
            'WRF_IC','WRF_CG','ENTLN_IC','ENTLN_CG',...
            };
