classdef BEHR_publishing_gridded_fields
    ...
    properties(Constant = true)
        ...
        psm_gridded_vars = {'BEHRColumnAmountNO2Trop',...
            ...
            'WRF_Column_NO2','WRF_Column_NO2_Visonly',...
            'WRF_Column_NO','WRF_Column_NO_Visonly',...
            'WRF_Column_HNO3','WRF_Column_HNO3_Visonly',...
            'WRF_Column_N2O5','WRF_Column_N2O5_Visonly',...
            'WRF_Column_NO3','WRF_Column_NO3_Visonly',...
            'WRF_Column_PAN','WRF_Column_PAN_Visonly',...
            'WRF_Column_HNO4','WRF_Column_HNO4_Visonly',...
            'WRF_Column_HONO','WRF_Column_HONO_Visonly',...
            'WRF_Column_MPAN','WRF_Column_MPAN_Visonly',...
            'WRF_Column_PPN','WRF_Column_PPN_Visonly',...
            'WRF_Column_MPN','WRF_Column_MPN_Visonly',...
            };
