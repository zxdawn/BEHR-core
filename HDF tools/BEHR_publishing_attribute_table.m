...
attr_table = {  'AmfStrat', 'unitless', [0, Inf], longfill, 'SP', 'Stratospheric AMF';...
                ...
                'WRF_Column_NO2', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric NO2 VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_NO2_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric NO2 VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_NO', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric NO VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_NO_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric NO VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_HNO3', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric HNO3 VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_HNO3_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric HNO3 VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_N2O5', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric N2O5 VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_N2O5_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric N2O5 VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_NO3', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric NO3 VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_NO3_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric NO3 VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_PAN', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric PAN VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_PAN_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric PAN VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_HNO4', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric HNO4 VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_HNO4_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric HNO4 VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_HONO', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric HONO VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_HONO_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric HONO VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_MPAN', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric MPAN VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_MPAN_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric MPAN VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_PPN', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric PPN VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_PPN_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric PPN VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                'WRF_Column_MPN', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric MPN VCD (WRF), calculated as SCD_trop / AMF_BEHR_VIS';...
                'WRF_Column_MPN_Visonly', 'molec./cm^2', [0, Inf], behrfill, 'WRF', 'Tropospheric MPN VCD (WRF) with only visible NO2 included, calculated as SCD_trop  / AMF_BEHR_VIS';...
                };
