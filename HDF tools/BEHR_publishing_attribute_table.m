...
attr_table = {  'AmfStrat', 'unitless', [0, Inf], longfill, 'SP', 'Stratospheric AMF';...
                ...
                'BEHRAMFTropLNO2', 'unitless', [0, Inf], behrfill, 'BEHR', 'Tropospheric AMF (BEHR) for lightning NO2 only, calculated with MODIS Albedo, GLOBE Terr. Pres., and LNO/LNO2 profiles';...
                'BEHRAMFTropLNO2VisOnly', 'unitless', [0, Inf], behrfill, 'BEHR', 'Tropospheric AMF (BEHR) for visible lightning NO2 only, calculated with MODIS Albedo, GLOBE Terr. Pres., and LNO/LNO2 profiles';...
                'BEHRAMFTropLNO2_pickering', 'unitless', [0, Inf], behrfill, 'BEHR', 'Pickering et al. Tropospheric AMF (BEHR) for lightning NO2 only, calculated with MODIS Albedo, GLOBE Terr. Pres., and lNO/lNO2 profiles';...
                'BEHRAMFTropLNOx', 'unitless', [0, Inf], behrfill, 'BEHR', 'Tropospheric AMF (BEHR) for lightning NOx only, calculated with MODIS Albedo, GLOBE Terr. Pres., and LNO/LNO2 profiles';...
                'BEHRAMFTropLNOxVisOnly', 'unitless', [0, Inf], behrfill, 'BEHR', 'Tropospheric AMF (BEHR) for visible lightning NOx only, calculated with MODIS Albedo, GLOBE Terr. Pres., and LNO/LNO2 profiles';...
                'BEHRAMFTropLNOx_pickering', 'unitless', [0, Inf], behrfill, 'BEHR', 'Pickering et al. Tropospheric AMF (BEHR) for lightning NOx only, calculated with MODIS Albedo, GLOBE Terr. Pres., and lNO/lNO2 profiles';...
                ...
                'BEHRColumnAmountNO2TropVisOnly', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Tropospheric visible NO2 VCD (BEHR) with only visible NO2 included, calculated as SCD_trop / AMF_BEHR_VIS';...
                'BEHRColumnAmountLNO2Trop', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Tropospheric LNO2 VCD (BEHR) calculated as SCD_trop / AMF_BEHR_LNO2';...
                'BEHRColumnAmountLNO2TropVisOnly', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Tropospheric visible LNO2 VCD (BEHR) calculated as SCD_trop / AMF_BEHR_LNO2_Vis';...
                'BEHRColumnAmountLNO2Trop_pickering', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Tropospheric LNO2 VCD (BEHR) calculated as SCD_trop / AMFLNO2_pickering';...
                'BEHRColumnAmountLNOxTrop', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Tropospheric LNOx VCD (BEHR) calculated as SCD_trop / AMF_BEHR_LNOx';...
                'BEHRColumnAmountLNOxTropVisOnly', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Tropospheric visible LNOx VCD (BEHR) calculated as SCD_trop / AMF_BEHR_LNOx_Vis';...
                'BEHRColumnAmountLNOxTrop_pickering', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Tropospheric LNOx VCD (BEHR) calculated as SCD_trop / AMFLNOx_pickering';...
                'WRFColumnAmountLNO2_Vis', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Modeled visible LNO2 VCD';...
                'WRFColumnAmountLNO2_Vis_ratio', 'molec./cm^2', [0, Inf], behrfill, 'BEHR', 'Modeled visible LNO2 VCD / Modeled visible NO2 VCD';...
                ...
                'WRFCloudFraction', 'unitless', [0, 1], shortfill, 'BEHR', 'WRF cloud fraction max between 350 hPa and 400 hPa';...
                ...
                'SlantColumnAmountNO2Destriped', 'molec./cm^2', [0, Inf], longfill, 'SP', 'Total NO2 de-striped SCD';...
                ...
                'Time_2D', 's', [0, Inf], longfill, 'SP', 'Time at start of scan (TAI93: seconds since Jan 1, 1993)';...
                ...
                'BEHRLNOapriori', 'parts-per-part', [-Inf, Inf], behrfill, 'BEHR', 'LNO a priori profile used for each pixel. Pressure levels given in BEHRPressureLevels.';...
                'BEHRLNO2apriori', 'parts-per-part', [-Inf, Inf], behrfill, 'BEHR', 'LNO2 a priori profile used for each pixel. Pressure levels given in BEHRPressureLevels.';...
