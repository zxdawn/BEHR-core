classdef BEHR_publishing_gridded_fields_sub
    ...
    properties(Constant = true)
        cvm_gridded_vars = {'AmfTrop', 'BEHRAMFTrop','BEHRAMFTropVisOnly',...
            'BEHRAMFTropLNO2','BEHRAMFTropLNO2VisOnly','BEHRAMFTropLNO2_pickering',...
            'BEHRAMFTropLNOx','BEHRAMFTropLNOxVisOnly','BEHRAMFTropLNOx_pickering',...
            'WRFCloudFraction','CloudFraction','CloudRadianceFraction','CloudPressure','GLOBETerpres',...
            'MODISAlbedo','MODISCloud','Row','BEHRTropopausePressure','Time_2D',...
            'PercentChangeNO2', 'PercentChangeNO2Vis', 'PercentChangeLNO2',...
            'PercentChangeLNO2_pickering', 'PercentChangeLNO2Vis',...
            'PercentChangeLNOx','PercentChangeLNOx_pickering', 'PercentChangeLNOxVis',...
            'PercentChangeAMF', 'PercentChangeAMFVis', 'PercentChangeAMFLNO2',...
            'PercentChangeAMFLNO2_pickering', 'PercentChangeAMFLNO2Vis',...
            'PercentChangeAMFLNOx', 'PercentChangeAMFLNOx_pickering', 'PercentChangeAMFLNOxVis'
            };
       
        psm_gridded_vars = {'BEHRColumnAmountNO2Trop',...   
            'BEHRColumnAmountNO2TropVisOnly',...
            'BEHRColumnAmountLNO2Trop',...
            'BEHRColumnAmountLNO2TropVisOnly',...
            'BEHRColumnAmountLNO2Trop_pickering',...
            'BEHRColumnAmountLNOxTrop',...
            'BEHRColumnAmountLNOxTropVisOnly',...
            'BEHRColumnAmountLNOxTrop_pickering',...
            'WRFColumnAmountLNO2_Vis',...
            'WRFColumnAmountLNO2_Vis_ratio',...
            'ColumnAmountNO2Trop'};
    ...
    methods(Static = true)
        function all_vars = all_gridded_vars(subset)
            ...
            all_vars = [BEHR_publishing_gridded_fields_sub.cvm_gridded_vars,...
                BEHR_publishing_gridded_fields_sub.psm_gridded_vars,...
                BEHR_publishing_gridded_fields_sub.psm_weight_vars(subset),...
                BEHR_publishing_gridded_fields_sub.cvm_weight_vars,...
                BEHR_publishing_gridded_fields_sub.reprocessed_psm_vars,... 
                BEHR_publishing_gridded_fields_sub.reprocessed_cvm_vars,...
                BEHR_publishing_gridded_fields_sub.flag_vars,...
                BEHR_publishing_gridded_fields_sub.publish_only_gridded_vars];
        end
        
        function all_psm_vars = all_psm_vars()
            all_psm_vars = [BEHR_publishing_gridded_fields_sub.psm_gridded_vars,...
                BEHR_publishing_gridded_fields_sub.reprocessed_psm_vars];
        end
        
        function all_cvm_vars = all_cvm_vars()
            all_cvm_vars = [BEHR_publishing_gridded_fields_sub.cvm_gridded_vars,...
                BEHR_publishing_gridded_fields_sub.reprocessed_cvm_vars];
        end
        ...
        function weight_vars = psm_weight_vars(subset)
            ...
            if strcmpi(subset, 'std')
                weight_vars = BEHR_publishing_gridded_fields_sub.psm_gridded_vars;
            elseif strcmpi(subset, 'insitu')
                weight_vars = BEHR_publishing_gridded_fields_sub.reprocessed_psm_vars;
            else
                weight_vars = BEHR_publishing_gridded_fields_sub.all_psm_vars;
            end

            for a=1:numel(weight_vars)
                weight_vars{a} = BEHR_publishing_gridded_fields_sub.make_wts_field(weight_vars{a});
            end
        end
